...
const FilterBar = ({ statusFilter, setStatusFilter, searchQuery, setSearchQuery, counts }) => {
            ...
            <div className="flex bg-white p-1.5 rounded-xl border border-slate-200/60 shadow-sm w-full sm:w-auto relative overflow-hidden">
                ...
                {tabs.map(tab => (
                    <button
                        ...
                        className={`relative z-10 flex-1 sm:flex-none px-6 py-2.5 rounded-xl text-sm font-semibold transition-all duration-500 flex items-center justify-center gap-2 ${
                            statusFilter === tab 
